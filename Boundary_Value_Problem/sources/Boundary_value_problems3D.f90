...
!
!**************************************************************************************************************
subroutine Boundary_Value_Problem3D_system(x_nodes, y_nodes, z_nodes, Order, N_variables, Differential_operator,  Boundary_conditions, Solution)
  ...
  !   linear2D = 
     ...
     if (linear3D) then 
              ...
              call Linear_Boundary_Value_Problem3D_system(x_nodes, y_nodes, z_nodes, Order, N_variables, Differential_operator,  Boundary_conditions, Solution)         
     else 
...
!
!**************************************************************************************************************
subroutine Linear_Boundary_Value_Problem3D_system(x_nodes, y_nodes, z_nodes, Order, N_variables, Differential_operator,  Boundary_conditions, Solution)
